...
public class ApostropheEscapingPropertiesPersisterTest {
    ...
    /**
     * Test method for
     * {@link de.ppi.spring.mvc.util.ApostropheEscapingPropertiesPersister#load(java.util.Properties, java.io.InputStream)}
     * .
     * 
    ...
    /**
     * Test method for
     * {@link de.ppi.spring.mvc.util.ApostropheEscapingPropertiesPersister#load(java.util.Properties, java.io.Reader)}
     * .
     * 
     * @throws Exception if something goes wrong.
     */
