...
public class ZeugnisInitialisierungServiceImplDbUnitIntegrationTest
    ...
    public void testInitZeugnisUpdate() throws Exception {
        ...
        assertThat(result.getMessages()).hasSize(2).contains(
              ...
              + " <li>Bewertung für Deutsch wurde konvertiert von AussenDifferenzierteBewertung nach DreiNiveauBewertung</li>\n\t"
              ...
              + " <li>Bewertung für Gesellschaftslehre wurde konvertiert von DreiNiveauBewertung nach AussenDifferenzierteBewertung</li>\n\t"
