...
public class UpdateZeugnis {
    ...
    public static IDataSet buildUpdateInit() throws DataSetException {
        ...
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(19L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("E").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(1L).ZeugnisId(3L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(20L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("E").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(2L).ZeugnisId(3L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(21L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("E").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(3L).ZeugnisId(3L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(22L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("E").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(4L).ZeugnisId(3L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(23L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("E").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(5L).ZeugnisId(3L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(24L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("E").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(6L).ZeugnisId(3L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(25L).LeistungNurSchwachAusreichend(Boolean.TRUE).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(10L).ZeugnisId(3L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(26L).LeistungNurSchwachAusreichend(Boolean.TRUE).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(11L).ZeugnisId(3L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(27L).LeistungNurSchwachAusreichend(Boolean.TRUE).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(12L).ZeugnisId(3L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(28L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("Z").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(1L).ZeugnisId(4L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(29L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("Z").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(2L).ZeugnisId(4L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(30L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("Z").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(3L).ZeugnisId(4L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(31L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("Z").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(4L).ZeugnisId(4L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(32L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("Z").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(5L).ZeugnisId(4L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(33L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("Z").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(6L).ZeugnisId(4L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(34L).LeistungNurSchwachAusreichend(Boolean.TRUE).Note(3L).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(10L).ZeugnisId(4L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(35L).LeistungNurSchwachAusreichend(Boolean.TRUE).Note(3L).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(11L).ZeugnisId(4L).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(36L).LeistungNurSchwachAusreichend(Boolean.TRUE).Note(3L).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(12L).ZeugnisId(4L).addTo(b);
        return b.build();
    }
    ...
    public static IDataSet buildUpdateResult(Long zeugnisId1, Long zeugnisId2) throws DataSetException {
        ...
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("E").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(1L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("E").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(4L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("Z").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(1L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("Z").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(4L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("G").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(2L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(3L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(5L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("G").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(6L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("G").Relevant(Boolean.FALSE).SonderNote("").SchulfachId(11L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("G").Relevant(Boolean.FALSE).SonderNote("").SchulfachId(12L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(13L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("G").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(2L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(3L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(5L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("G").Note(3L).Relevant(Boolean.FALSE).SonderNote("X").SchulfachId(6L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("G").Note(3L).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(11L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.TRUE).Leistungsniveau("G").Note(3L).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(12L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(13L).ZeugnisId(zeugnisId2).addTo(b);
        return b.build();
    }
}
