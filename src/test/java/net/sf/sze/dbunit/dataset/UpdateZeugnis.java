...
public class UpdateZeugnis {
    ...
    public static IDataSet buildUpdateInit() throws DataSetException {
        ...
        newZeugnisFormular().Id(2L).AusgabeDatum(Date.valueOf("2013-07-01")).Beschreibung("2013 zweites Halbjahr").NachteilsAusgleichsDatum(Date.valueOf("2012-09-14")).TemplateFileName("egal").KlasseId(2L).KlassenSuffix("b").SchulhalbjahrId(1L).addTo(b);
        newZeugnis().Id(3L).AnzahlFehltageGesamt(0).AnzahlFehltageUnentschuldigt(0).AnzahlVerspaetungen(0).BuBewertungsText("").KlassenZielAusgeschlossen(Boolean.FALSE).KlassenZielGefaehrdet(Boolean.FALSE).KlassenZielWurdeNichtErreicht(Boolean.FALSE).RuecktAuf(Boolean.TRUE).FormularId(1L).SchuelerId(1L).ZeugnisArtId(1L).addTo(b);
        newZeugnis().Id(4L).AnzahlFehltageGesamt(0).AnzahlFehltageUnentschuldigt(0).AnzahlVerspaetungen(0).BuBewertungsText("").KlassenZielAusgeschlossen(Boolean.FALSE).KlassenZielGefaehrdet(Boolean.FALSE).KlassenZielWurdeNichtErreicht(Boolean.FALSE).RuecktAuf(Boolean.TRUE).FormularId(1L).SchuelerId(2L).ZeugnisArtId(1L).addTo(b);
    ...
    public static IDataSet buildUpdateResult(Long zeugnisId1, Long zeugnisId2) throws DataSetException {
        final DataSetBuilder b = new DataSetBuilder();
        newZeugnis().Id(zeugnisId1).Version(1L).AnzahlFehltageGesamt(0).AnzahlFehltageUnentschuldigt(0).AnzahlVerspaetungen(0).BuBewertungsText("").KlassenZielAusgeschlossen(Boolean.FALSE).KlassenZielGefaehrdet(Boolean.FALSE).KlassenZielWurdeNichtErreicht(Boolean.FALSE).RuecktAuf(Boolean.TRUE).FormularId(2L).SchuelerId(1L).ZeugnisArtId(1L).addTo(b);
        newZeugnis().Id(zeugnisId2).Version(1L).AnzahlFehltageGesamt(0).AnzahlFehltageUnentschuldigt(0).AnzahlVerspaetungen(0).BuBewertungsText("").KlassenZielAusgeschlossen(Boolean.FALSE).KlassenZielGefaehrdet(Boolean.FALSE).KlassenZielWurdeNichtErreicht(Boolean.FALSE).RuecktAuf(Boolean.TRUE).FormularId(2L).SchuelerId(2L).ZeugnisArtId(1L).addTo(b);
