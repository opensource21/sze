...
public class Anonymisierung {
    ...
    public static IDataSet buildVariableInit() throws DataSetException {
        ...
        newZeugnis().Id(3L).AnzahlFehltageGesamt(0).AnzahlFehltageUnentschuldigt(0).AnzahlVerspaetungen(0).BuBewertungsText("ERWIN MUSTERMANN IST fleissigA").KlassenZielAusgeschlossen(Boolean.FALSE).KlassenZielGefaehrdet(Boolean.FALSE).KlassenZielWurdeNichtErreicht(Boolean.FALSE).RuecktAuf(Boolean.TRUE).FormularId(1L).SchuelerId(1L).ZeugnisArtId(1L).addTo(b);
        newZeugnis().Id(4L).AnzahlFehltageGesamt(0).AnzahlFehltageUnentschuldigt(0).AnzahlVerspaetungen(0).BuBewertungsText("ERNA MUSTERFRAU ist fleissigB").KlassenZielAusgeschlossen(Boolean.FALSE).KlassenZielGefaehrdet(Boolean.FALSE).KlassenZielWurdeNichtErreicht(Boolean.FALSE).RuecktAuf(Boolean.TRUE).FormularId(1L).SchuelerId(2L).ZeugnisArtId(1L).addTo(b);
