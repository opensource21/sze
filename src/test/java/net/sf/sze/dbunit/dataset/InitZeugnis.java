...
public class InitZeugnis {
    ...
    public static IDataSet buildInitResult(Long zeugnisId1, Long zeugnisId2,
        ...
        final DataSetBuilder b = new DataSetBuilder();
        newZEUGNIS(b).ID(zeugnisId1).VERSION(0L).ANZAHL_FEHLTAGE_GESAMT(0).ANZAHL_FEHLTAGE_UNENTSCHULDIGT(0).ANZAHL_VERSPAETUNGEN(0).BU_BEWERTUNGS_TEXT("").INDIVIDUELLER_LEITSPRUCH((String) null).INDIVIDUELLER_LEITSPRUCH2((String) null).INDIVIDUELLES_AUSGABE_DATUM((Timestamp) null).KLASSEN_ZIEL_AUSGESCHLOSSEN(Boolean.FALSE).KLASSEN_ZIEL_GEFAEHRDET(Boolean.FALSE).KLASSEN_ZIEL_WURDE_NICHT_ERREICHT(Boolean.FALSE).QUELLE_INDIVIDUELLER_LEITSPRUCH((String) null).QUELLE_INDIVIDUELLER_LEITSPRUCH2((String) null).RUECKT_AUF(Boolean.TRUE).FORMULAR_ID(formularId).KLASSE_ID(1L).SCHUELER_ID(1L).SCHULHALBJAHR_ID(halbjahrId).SOLBEWERTUNGS_TEXT_ID((Long) null).ZEUGNIS_ART_ID(1L).add();
        newZEUGNIS(b).ID(zeugnisId2).VERSION(0L).ANZAHL_FEHLTAGE_GESAMT(0).ANZAHL_FEHLTAGE_UNENTSCHULDIGT(0).ANZAHL_VERSPAETUNGEN(0).BU_BEWERTUNGS_TEXT("").INDIVIDUELLER_LEITSPRUCH((String) null).INDIVIDUELLER_LEITSPRUCH2((String) null).INDIVIDUELLES_AUSGABE_DATUM((Timestamp) null).KLASSEN_ZIEL_AUSGESCHLOSSEN(Boolean.FALSE).KLASSEN_ZIEL_GEFAEHRDET(Boolean.FALSE).KLASSEN_ZIEL_WURDE_NICHT_ERREICHT(Boolean.FALSE).QUELLE_INDIVIDUELLER_LEITSPRUCH((String) null).QUELLE_INDIVIDUELLER_LEITSPRUCH2((String) null).RUECKT_AUF(Boolean.TRUE).FORMULAR_ID(formularId).KLASSE_ID(1L).SCHUELER_ID(2L).SCHULHALBJAHR_ID(halbjahrId).SOLBEWERTUNGS_TEXT_ID((Long) null).ZEUGNIS_ART_ID(1L).add();
        ...
        newAV_SV_BEWERTUNG(b).ID(new GreaterThan(0)).VERSION(0L).BEURTEILUNG((Integer) null).ARBEITS_UND_SOZIAL_VERHALTEN_ID(1L).ZEUGNIS_ID(zeugnisId1).add();
        newAV_SV_BEWERTUNG(b).ID(new GreaterThan(0)).VERSION(0L).BEURTEILUNG((Integer) null).ARBEITS_UND_SOZIAL_VERHALTEN_ID(10L).ZEUGNIS_ID(zeugnisId1).add();
        newAV_SV_BEWERTUNG(b).ID(new GreaterThan(0)).VERSION(0L).BEURTEILUNG((Integer) null).ARBEITS_UND_SOZIAL_VERHALTEN_ID(1L).ZEUGNIS_ID(zeugnisId2).add();
        newAV_SV_BEWERTUNG(b).ID(new GreaterThan(0)).VERSION(0L).BEURTEILUNG((Integer) null).ARBEITS_UND_SOZIAL_VERHALTEN_ID(10L).ZEUGNIS_ID(zeugnisId2).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU("G").NOTE((Long) null).RELEVANT(Boolean.TRUE).SONDER_NOTE("").SCHULFACH_ID(1L).ZEUGNIS_ID(zeugnisId1).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU("G").NOTE((Long) null).RELEVANT(Boolean.TRUE).SONDER_NOTE("").SCHULFACH_ID(2L).ZEUGNIS_ID(zeugnisId1).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU("G").NOTE((Long) null).RELEVANT(Boolean.TRUE).SONDER_NOTE("").SCHULFACH_ID(3L).ZEUGNIS_ID(zeugnisId1).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU("G").NOTE((Long) null).RELEVANT(Boolean.TRUE).SONDER_NOTE("").SCHULFACH_ID(4L).ZEUGNIS_ID(zeugnisId1).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU("G").NOTE((Long) null).RELEVANT(Boolean.TRUE).SONDER_NOTE("").SCHULFACH_ID(5L).ZEUGNIS_ID(zeugnisId1).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU("G").NOTE((Long) null).RELEVANT(Boolean.TRUE).SONDER_NOTE("").SCHULFACH_ID(6L).ZEUGNIS_ID(zeugnisId1).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.StandardBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU((String) null).NOTE((Long) null).RELEVANT(Boolean.FALSE).SONDER_NOTE("").SCHULFACH_ID(10L).ZEUGNIS_ID(zeugnisId1).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.StandardBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU((String) null).NOTE((Long) null).RELEVANT(Boolean.FALSE).SONDER_NOTE("").SCHULFACH_ID(11L).ZEUGNIS_ID(zeugnisId1).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.StandardBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU((String) null).NOTE((Long) null).RELEVANT(Boolean.FALSE).SONDER_NOTE("").SCHULFACH_ID(12L).ZEUGNIS_ID(zeugnisId1).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU("G").NOTE((Long) null).RELEVANT(Boolean.TRUE).SONDER_NOTE("").SCHULFACH_ID(1L).ZEUGNIS_ID(zeugnisId2).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU("G").NOTE((Long) null).RELEVANT(Boolean.TRUE).SONDER_NOTE("").SCHULFACH_ID(2L).ZEUGNIS_ID(zeugnisId2).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU("G").NOTE((Long) null).RELEVANT(Boolean.TRUE).SONDER_NOTE("").SCHULFACH_ID(3L).ZEUGNIS_ID(zeugnisId2).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU("G").NOTE((Long) null).RELEVANT(Boolean.TRUE).SONDER_NOTE("").SCHULFACH_ID(4L).ZEUGNIS_ID(zeugnisId2).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU("G").NOTE((Long) null).RELEVANT(Boolean.TRUE).SONDER_NOTE("").SCHULFACH_ID(5L).ZEUGNIS_ID(zeugnisId2).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU("G").NOTE((Long) null).RELEVANT(Boolean.TRUE).SONDER_NOTE("").SCHULFACH_ID(6L).ZEUGNIS_ID(zeugnisId2).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.StandardBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU((String) null).NOTE((Long) null).RELEVANT(Boolean.FALSE).SONDER_NOTE("").SCHULFACH_ID(10L).ZEUGNIS_ID(zeugnisId2).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.StandardBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU((String) null).NOTE((Long) null).RELEVANT(Boolean.FALSE).SONDER_NOTE("").SCHULFACH_ID(11L).ZEUGNIS_ID(zeugnisId2).add();
        newBEWERTUNG(b).CLASS("net.sf.sze.zeugnis.StandardBewertung").ID(new GreaterThan(0)).VERSION(0L).LEISTUNG_NUR_SCHWACH_AUSREICHEND(Boolean.FALSE).LEISTUNGSNIVEAU((String) null).NOTE((Long) null).RELEVANT(Boolean.FALSE).SONDER_NOTE("").SCHULFACH_ID(12L).ZEUGNIS_ID(zeugnisId2).add();
        return b.build();
