...
public class InitZeugnis {
    ...
    public static IDataSet buildInitResult(Long zeugnisId1, Long zeugnisId2,
        ...
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Leistungsniveau("G").Relevant(Boolean.TRUE).SonderNote("").SchulfachId(1L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Leistungsniveau("G").Relevant(Boolean.TRUE).SonderNote("").SchulfachId(2L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Leistungsniveau("G").Relevant(Boolean.TRUE).SonderNote("").SchulfachId(3L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Leistungsniveau("G").Relevant(Boolean.TRUE).SonderNote("").SchulfachId(4L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Leistungsniveau("G").Relevant(Boolean.TRUE).SonderNote("").SchulfachId(5L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Leistungsniveau("G").Relevant(Boolean.TRUE).SonderNote("").SchulfachId(6L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(10L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(11L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(12L).ZeugnisId(zeugnisId1).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Leistungsniveau("G").Relevant(Boolean.TRUE).SonderNote("").SchulfachId(1L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Leistungsniveau("G").Relevant(Boolean.TRUE).SonderNote("").SchulfachId(2L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.AussenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Leistungsniveau("G").Relevant(Boolean.TRUE).SonderNote("").SchulfachId(3L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Leistungsniveau("G").Relevant(Boolean.TRUE).SonderNote("").SchulfachId(4L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Leistungsniveau("G").Relevant(Boolean.TRUE).SonderNote("").SchulfachId(5L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.BinnenDifferenzierteBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Leistungsniveau("G").Relevant(Boolean.TRUE).SonderNote("").SchulfachId(6L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(10L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(11L).ZeugnisId(zeugnisId2).addTo(b);
        newBewertung().Class("net.sf.sze.zeugnis.StandardBewertung").Id(new GreaterThan(0)).Version(0L).LeistungNurSchwachAusreichend(Boolean.FALSE).Relevant(Boolean.FALSE).SonderNote("").SchulfachId(12L).ZeugnisId(zeugnisId2).addTo(b);
        return b.build();
